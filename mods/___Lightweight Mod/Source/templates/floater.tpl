Group
{
	...
	Variable
	{
		...
		description = ""
		value = ""
		defaultValue = "%TEMPLATE_DIR%database\Templates\Actor.tpl"
	}
	...
	Group
	{
		...
		Variable
		{
			...
			class = "variable"
			type = "real"
			description = "Time to complete a bob from top to bottom"
			value = ""
			defaultValue = "0"
		}
		...
		Variable
		{
			...
			class = "variable"
			type = "real"
			description = "Maximum amplitude of bob"
			value = ""
			defaultValue = "0"
		}
...
{
	"Templates\Copy of Decoration.tpl"
}
