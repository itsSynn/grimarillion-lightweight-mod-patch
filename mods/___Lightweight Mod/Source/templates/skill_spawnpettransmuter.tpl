Group
{
	...
	Group
	{
		...
		Variable
		{
			...
			description = ""
			value = ""
			defaultValue = "Skill_SpawnPetTransmuter"
		}
	...
	Group
	{
		...
		Variable
		{
			...
			class = "array"
			type = "file_dbr"
			description = "overrides base skill"
			value = ""
			defaultValue = ""
		}
		...
		Variable
		{
			name = "modSpawnObjectsTimeToLive"
			class = "array"
			type = "real"
			description = "overrides base skill (seconds) (-1 for permanent)"
			value = ""
			defaultValue = ""
		}
