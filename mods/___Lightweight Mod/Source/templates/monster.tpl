Group
{
	...
	Variable
	{
		...
		description = ""
		value = ""
		defaultValue = "database\Templates\TemplateBase\MonsterSkillManager.tpl"
	}
	...
	Group
	{
		...
		Variable
		{
			...
			class = "array"
			type = "file_dbr"
			description = "Item dbrs to drop for each player in a multiplayer game"
			value = ""
			defaultValue = ""
		}
		...
		Variable
		{
			name = "perPartyMemberDropChance"
			class = "array"
			type = "int"
			description = "Chance of dropping each item dbr per player in multiplayer game"
			value = ""
			defaultValue = "100"
		}
		...
		Variable
		{
			...
			class = "variable"
			type = "int"
			description = "percent of max health to gain when killing players"
			value = ""
			defaultValue = "0"
		}
		...
		Variable
		{
			...
			class = "variable"
			type = "int"
			description = "difficulty level where health gain is enabled"
			value = ""
			defaultValue = "0"
		}
		...
		Variable
		{
			...
			class = "variable"
			type = "bool"
			description = "force collision (ignores hostility)"
			value = ""
			defaultValue = "0"
		}
		...
		Variable
		{
			name = "forceNoCollision"
			class = "variable"
			type = "bool"
			description = "force no collision (ignores hostility)"
			value = ""
			defaultValue = "0"
		}
		...
		Variable
		{
			...
			class = "variable"
			type = "bool"
			description = "Force a monster to be destroyed on unload"
			value = ""
			defaultValue = "0"
		}
