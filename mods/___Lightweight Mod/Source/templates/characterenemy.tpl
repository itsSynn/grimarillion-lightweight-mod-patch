Group
{
	...
	Variable
	{
		...
		description = ""
		value = ""
		defaultValue = "%TEMPLATE_DIR%database\templates\Actor.tpl"
	}
	...
	Variable
	{
		...
		description = ""
		value = ""
		defaultValue = "database\Templates\TemplateBase\CharacterBioEnemy.tpl"
	}
...
{
	"Templates\Copy of Character.tpl"
}
