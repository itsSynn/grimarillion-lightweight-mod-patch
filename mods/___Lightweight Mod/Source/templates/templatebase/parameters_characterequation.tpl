...
{
	"Templates\TemplateBase\Copy of Parameters_Character.tpl"
	"Templates\TemplateBase\Parameters_CharacterEquation.tpl"
	"Templates\TemplateBase\OLDParameters_CharacterEquation.tpl"
}
