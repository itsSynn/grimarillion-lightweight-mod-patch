Group
{
	...
	Group
	{
		...
		Group
		{
			...
			Variable
			{
				name = "characterLifeMultModifier"
				class = "array"
				type = "real"
				description = ""
				value = ""
		...
		Group
		{
			...
			Variable
			{
				name = "characterRunSpeedMaxModifier"
				class = "array"
				type = "real"
				description = ""
				value = ""
			...
			Variable
			{
				name = "characterAttackSpeedMaxModifier"
				class = "array"
				type = "real"
				description = ""
				value = ""
			...
			Variable
			{
				name = "characterSpellCastSpeedMaxModifier"
				class = "array"
				type = "real"
				description = ""
				value = ""
		...
		Group
		{
			...
			Variable
			{
				name = "characterConstitutionModifier"
				class = "array"
				type = "real"
				description = ""
				value = ""
			...
			Variable
			{
				name = "characterHealIncreasePercent"
				class = "array"
				type = "real"
				description = "Absolute and Percent heal modifier"
				value = ""
				defaultValue = "0"
			}
			...
			Variable
			{
				name = "characterPercentHealIncreaseModifier"
				class = "array"
				type = "real"
				description = "Percent heal modifier"
				value = ""
				defaultValue = "0"
			}
		...
		Group
		{
			...
			Variable
			{
				name = "characterWeapon2HStrengthReqReduction"
				class = "array"
				type = "real"
				description = ""
				value = ""
			...
			Variable
			{
				name = "characterWeapon2HDexterityReqReduction"
				class = "array"
				type = "real"
				description = ""
				value = ""
			...
			Variable
			{
				name = "characterWeapon2HIntelligenceReqReduction"
				class = "array"
				type = "real"
				description = ""
				value = ""
